...
class Application(ttk.Frame):
    ...
    def Add(self):
        ...
        self.AddComponent = ttk.Button(top, text="Add EQ", command=self.fAddComponent)
        self.AddComponent.place(height=40, width=80, x=15, y=445, )

        self.ClearComponent = ttk.Button(top, text="Clear", command=self.fClearComponent)
        self.ClearComponent.place(height=40, width=80, x=110, y=445, )

        self.QuitComponent = ttk.Button(top, text="Quit", command=self.fQuitComponent)
...
'''
    ...
    def create_widgets(self):
        ...
        self.AddComp = ttk.Button(root, text="Add new Eq", command=self.Add)
        self.AddComp.place(height=40, width=80, x=15, y=15)

        self.ShowComp = ttk.Button(root, text="Show list", command=self.ShowListOfComponents)
        self.ShowComp.place(height=40, width=80, x=15, y=65)

        self.FindComp = ttk.Button(root, text="Find", command=self.find)
        self.FindComp.place(height=40, width=80, x=15, y=115)

        self.DeleteComp = ttk.Button(root, text="Delete Eq", command=self.delete)
        self.DeleteComp.place(height=40, width=80, x=15, y=165)

        self.AddComp = ttk.Button(root, text="<", command=self.say_hi)
        self.AddComp.place(height=40, width=80, x=700, y=430)

        self.AddComp = ttk.Button(root, text=">", command=self.say_hi)
        self.AddComp.place(height=40, width=80, x=880, y=430)

        self.AddComp = ttk.Button(root, text="INFO", command=self.say_hi)
        self.AddComp.place(height=40, width=80, x=790, y=430)

        self.AddComp = ttk.Button(root, text="Quit", command=self.master.destroy)
        self.AddComp.place(height=40, width=80, x=950, y=665)

        self.AddComp = ttk.Button(root, text="+", command=self.master.destroy)
        self.AddComp.place(height=40, width=40, x=265, y=240)

        self.AddComp = ttk.Button(root, text="-", command=self.master.destroy)
        self.AddComp.place(height=40, width=40, x=214, y=240)

        self.Zastepcze = ttk.Button(root, text="Tutaj Obrazek", command=self.say_hi)
        self.Zastepcze.place(height=400, width=400, x=630, y=15)

        self.AddComp = ttk.Button(root, text="Export1", command=self.say_hi)
        self.AddComp.place(height=40, width=80, x=15, y=500)

        self.AddComp = ttk.Button(root, text="Export2", command=self.say_hi)
        self.AddComp.place(height=40, width=80, x=110, y=500)

        self.AddComp = ttk.Button(root, text="Export3", command=self.say_hi)
        self.AddComp.place(height=40, width=80, x=205, y=500)

        self.Kategoria = ttk.Entry(root, width=50)
        self.Kategoria.place(height=25, width=100, x=210, y=50)

        self.Typ = ttk.Entry(root, width=50)
        self.Typ.place(height=25, width=100, x=210, y=100)

        self.Ilosc = ttk.Entry(root, width=50)
        self.Ilosc.place(height=25, width=100, x=210, y=150)

        self.Where = ttk.Entry(root, width=50)
        self.Where.place(height=25, width=100, x=210, y=200)

        self.Informacje = ttk.Label(root, text="Information:")
        self.Informacje.place(height=40, width=80, x=350, y=10)

        self.Informacje = ttk.Label(root, text="Fast Find:", )
        self.Informacje.place(height=40, width=80, x=120, y=10)

        self.Informacje = ttk.Label(root, text="Category:", )
        self.Informacje.place(height=40, width=80, x=120, y=40)

        self.Informacje = ttk.Label(root, text="Type:", )
        self.Informacje.place(height=40, width=80, x=120, y=90)

        self.Informacje = ttk.Label(root, text="Where:", )
        ...
        self.Informacje = ttk.Label(root, text="text")
